                    ...
                    <div class="cell auto ">
                        ...
                        <div class="">
                            <ul class="details font_n1 no-bullet padding-left_3 padding-right_3 margin-bottom_0 grid-x grid-margin-x">
                                ...
                                <li class="cell small-12 large-6 padding_2"><a class="link color_primary float-right">open member record<i class="margin-left_3 margin-right_3 fas fa-arrow-square-right"></i></a></li>
                            </ul>
                        </div>                        
